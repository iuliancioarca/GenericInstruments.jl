...
# Channel coupling
GI.SCOPE.set_coupling(niScope1;ch="1",cpl=2)
GI.SCOPE.niScope_GetAttributeViInt32(niScope1, "1", 1250003) #OK
# Channel state on/off
GI.SCOPE.set_ch_state(niScope1;ch="1",st="on")
GI.SCOPE.niScope_GetAttributeViBoolean(niScope1, "1", 1250005) #OK
# Probe attenuation
GI.SCOPE.set_atten(niScope1;ch="1",atten=100.0)
GI.SCOPE.niScope_GetAttributeViReal64(niScope1, "1", 1250004) # always returns 1.0!!!
# BW limit
GI.SCOPE.set_bw_lim(niScope1;ch="1",bw=20000000.0)
GI.SCOPE.niScope_GetAttributeViReal64(niScope1, "1", 1250006) #OK
## VERTICAL
# Vrange
GI.SCOPE.set_vrange(niScope1;ch="1",vrang=0.35)
GI.SCOPE.niScope_GetAttributeViReal64(niScope1, "1", 1250001) #OK, it approximates to next value
# Vertical offset
GI.SCOPE.set_voffs(niScope1;ch="1",voffs=0.12)
GI.SCOPE.niScope_GetAttributeViReal64(niScope1, "1", 1250002) #OK
## HORIZONTAL
...
## TRIGGER
# Set trigger type
GI.SCOPE.set_trig_typ(niScope1;tp=3)
GI.SCOPE.niScope_GetAttributeViInt32(niScope1, "", 1250012) #OK, find triggertype enum!
# Set trigger source
GI.SCOPE.set_trig_src(niScope1;val="VAL_EXTERNAL") #can be channel:"0" or "VAL_EXTERNAL", etc. check enum
...
GI.SCOPE.set_trig_cpl(niScope1;ch="1",cpl=1001)
GI.SCOPE.niScope_GetAttributeViInt32(niScope1, "1", 1250014) #always returns 0
